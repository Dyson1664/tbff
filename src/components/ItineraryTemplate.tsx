...
export const ItineraryTemplate = memo(({ data }: ItineraryTemplateProps) => {
  ...
  return (
    <div className={STATIC_STYLES.gradient}>
      ...
      {/* Hero Section (custom) */}
        <section className="relative h-[55vh] md:h-[70vh] flex overflow-hidden md:mx-6 lg:mx-12 xl:mx-16 rounded-none md:rounded-2xl mt-0 md:mt-6 bg-transparent md:bg-white p-0 md:p-6 shadow-none md:shadow-sm">
