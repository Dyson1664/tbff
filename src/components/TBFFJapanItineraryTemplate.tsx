...
interface TripHighlight {
  ...
  video?: string;       // URL or path to your reel (mp4)
  poster?: string;      // optional poster/thumbnail for the video
}
...
const TripHighlights = memo(({ data }: { data: CountryData }) => {
  ...
  const defaultHighlights: TripHighlight[] = [
    ...
    },
    {
      ...
      description:
        "Visit world-famous monuments and architectural marvels that define this incredible destination.",
      image: data.aboutImages[1] || data.heroImage,
    },
    {
      title: "Local Cuisine",
      description:
        "Savor authentic regional dishes and discover the flavors that make this cuisine unique.",
                ...
                <div className="space-y-3">
                  ...
                  {highlight.video ? (
                    <video
                      ...
                      playsInline
                      controls
                      className="w-full h-56 md:h-64 lg:h-72 object-cover rounded-2xl shadow-md bg-black"
                    />
                  ) : (
                    <img
                      src={highlight.image}
                  ...
                  <div className="text-center space-y-2">
                    ...
                    {/* description removed on desktop */}
                  </div>
                </div>
              </CarouselItem>
            ))}
                ...
                <div className="space-y-3 w-full max-w-80 mx-auto">
                  ...
                  {highlight.video ? (
                    <video
                      ...
                      playsInline
                      controls
                      className="w-full h-56 object-cover rounded-2xl shadow-md bg-black"
                    />
                  ) : (
                    <img
                      src={highlight.image}
...
export const TBFFJapanItineraryTemplate = memo(({ data, logoStyle, FooterComponent }: ItineraryTemplateProps) => {
...
export default TBFFJapanItineraryTemplate;
