  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        ...
        // Optional: make the *trigger itself* pink on hover/open
        // (your inner h2/h3 also set their own colors below)
        "hover:text-[#F4909F] data-[state=open]:text-[#F4909F]",

        // Chevron rotation + color
        "[&[data-state=open]>svg]:rotate-180",
        "hover:[&>svg]:text-[#F4909F] data-[state=open]:[&>svg]:text-[#F4909F]",
