...
export const DayLayout = memo(({ 
  ...
  return (
    <div className="bg-muted/70 rounded-lg shadow-sm border-2 border-border overflow-hidden mb-8">
      {/* Day Header */}
      <div className="p-10 pb-6 lg:px-20 lg:pt-20 lg:pb-12 bg-white">
      ...
      {/* Description */}
      <div className="p-10 lg:px-20 lg:py-16 bg-white">
      ...
      {experiences.length > 0 && (
        <div className="px-10 pb-10 lg:px-20 lg:pb-20 bg-white">
