...
import { thailandData } from "@/data/countries/thailand"; // Placeholder - replace with colombiaData when available
...
const TBFFColombiaItinerary = () => {
  ...
  return (
    <div className="tbff-theme">
      ...
      `}</style>
      <ItineraryTemplate data={thailandData} logoStyle={tbffLogoStyle} FooterComponent={TBFFFooter} />
    </div>
  );
};
