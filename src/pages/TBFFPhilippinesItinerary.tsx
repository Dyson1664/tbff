...
const TBFFPhilippinesItinerary = () => {
  ...
  return (
    <div className="tbff-theme">
      ...
      `}</style>
      <ItineraryTemplate data={philippinesData} logoStyle={tbffLogoStyle} FooterComponent={TBFFFooter} />
    </div>
  );
};

export default TBFFPhilippinesItinerary;
