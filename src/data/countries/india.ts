...
export const indiaData = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "The local currency in India is the Indian Rupee (INR). We advise guests to first collect cash from the airport ATMs, and there will also be various ATMs available along the way."
    },
    {
